...
{
#ifndef KSU_KPROBES_HOOK && !defined(CONFIG_KSU_SUSFS)
    if (!ksu_execveat_hook) {
        return 0;
    }
#endif // #ifndef KSU_KPROBES_HOOK && !defined(CONFIG_KSU_SUSFS)
...
#ifndef CONFIG_KSU_SUSFS
static ksu_handle_sys_read(unsigned int fd, char __user **buf_ptr,
                               size_t *count_ptr)
#else
